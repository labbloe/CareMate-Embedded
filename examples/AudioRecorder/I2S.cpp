...
void I2S_Init(i2s_mode_t MODE, i2s_bits_per_sample_t BPS)
{
  i2s_config_t i2s_config = {
      ...
      .bits_per_sample = BPS,
      .channel_format = I2S_CHANNEL_FMT_RIGHT_LEFT,     //Previously set to: I2S_CHANNEL_FMT_RIGHT_LEFT
  ...
  if (MODE == I2S_MODE_RX || MODE == I2S_MODE_TX) {
    ...
    i2s_driver_install(I2S_NUM_0, &i2s_config, 0, NULL);
    // GPIO36, VP
    i2s_set_adc_mode(ADC_UNIT_1, ADC1_CHANNEL_7);  //ADC2_CHANNEL_7 is GPIO27
  }
}
